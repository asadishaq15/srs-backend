...
async function seed() {
  ...
  // 8. Grades
  for (const [child, course, teacher] of [
    [child1, math, teacher1],
    [child2, english, teacher2],
    [child3, science, teacher3],
  ]) {
    await Grade.create({
      teacherId: teacher._id,
      courseId: course._id,
      ...
      section: child.section,
      term: "Spring 2024",
      quiz: { score: 18, weightage: 20 },
      midTerm: { score: 40, weightage: 40 },
      project: { score: 20, weightage: 20 },
      finalTerm: { score: 17, weightage: 20 },
      overAll: 95 - Math.floor(Math.random() * 10),
    });
  }
